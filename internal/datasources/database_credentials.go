...
var (
	_ datasource.DataSource              = &DatabaseCredential{}
	_ datasource.DataSourceWithConfigure = &DatabaseCredential{}
)

// DatabaseCredential is the database credential data source implementation.
type DatabaseCredential struct {
	*providerschema.Data
}

// NewDatabaseCredential is a helper function to simplify the provider implementation.
func NewDatabaseCredential() datasource.DataSource {
	return &DatabaseCredential{}
}

// Metadata returns the database credential data source type name.
func (d *DatabaseCredential) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *DatabaseCredential) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *DatabaseCredential) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	default:
		resp.Diagnostics.AddError(
			"Error Reading Capella Database Credentials",
			"Could not read database credentials in cluster "+clusterId+": "+err.Error(),
		)
		return
	}
...
func (d *DatabaseCredential) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
