...
func ProjectEventSchema() schema.Schema {
	return schema.Schema{
		MarkdownDescription: "Data source to retrieve an event for a project. Events represent a trail of actions that users performs within Capella at the project level.",
