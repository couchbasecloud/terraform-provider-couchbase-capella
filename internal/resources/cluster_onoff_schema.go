...
func ClusterOnOffOnDemandSchema() schema.Schema {
	...
	capellaschema.AddAttr(attrs, "organization_id", clusterOnOffBuilder, requiredUUIDStringAttribute())
	capellaschema.AddAttr(attrs, "project_id", clusterOnOffBuilder, requiredUUIDStringAttribute())
	capellaschema.AddAttr(attrs, "cluster_id", clusterOnOffBuilder, requiredUUIDStringAttribute())
