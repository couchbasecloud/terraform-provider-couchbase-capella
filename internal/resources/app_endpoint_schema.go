			...
			"oidc": schema.ListNestedAttribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"user_prefix":    WithDescription(stringDefaultAttribute("", optional, computed), "The user prefix for OIDC users."),
						...
						"is_default":     WithDescription(boolAttribute(computed, useStateForUnknown), "States whether this is the default OIDC provider."),
					},
				},
			},
