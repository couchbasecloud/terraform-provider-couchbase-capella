...
func AppServiceLogStreamingSchema() schema.Schema {
	...
	// ID field - computed, equals app_service_id
	capellaschema.AddAttr(attrs, "id", appServiceLogStreamingBuilder, stringAttribute([]string{computed, useStateForUnknown}))
	...
	// Build credentials nested attribute
