...
func CorsSchema() schema.Schema {
	...
	capellaschema.AddAttr(attrs, "organization_id", corsBuilder, requiredUUIDStringAttribute())
	capellaschema.AddAttr(attrs, "project_id", corsBuilder, requiredUUIDStringAttribute())
	capellaschema.AddAttr(attrs, "cluster_id", corsBuilder, requiredUUIDStringAttribute())
	capellaschema.AddAttr(attrs, "app_service_id", corsBuilder, requiredUUIDStringAttribute())
	...
	capellaschema.AddAttr(attrs, "origin", corsBuilder, &schema.SetAttribute{
