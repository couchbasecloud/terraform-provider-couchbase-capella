...
type CloudProvider struct {
	...
	// Region Cloud provider region, e.g. 'us-west-2'. For information about supported regions, see [Amazon Web Services](https://docs.couchbase.com/cloud/reference/aws.html).
...
type ServiceGroup struct {
	...
	// NumOfNodes Number of nodes. The minimum number of nodes for the cluster can be 3 and maximum can be 27 nodes. Additional service groups can have 2 nodes minimum and 24 nodes maximum.
