...
type AppServiceLogStreaming struct {
	...
	// Id is the unique identifier for the log streaming configuration (equals AppServiceId).
...
func NewAppServiceLogStreaming(
	...
	result := &AppServiceLogStreaming{
		...
		Id:             types.StringValue(appServiceId), // ID equals AppServiceId for this singleton resource
