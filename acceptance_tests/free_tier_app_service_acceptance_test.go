...
func TestAccFreeTierAppServiceResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccFreeTierAppServiceResourceRequiredOnlyConfig(clusterName, appServiceName, cidr),
...
func testAccFreeTierAppServiceResourceRequiredOnlyConfig(clusterName, appServiceName, cidr string) string {
	return fmt.Sprintf(`
%[1]s
...
`, globalProviderBlock, globalOrgId, globalProjectId, clusterName, appServiceName, cidr)
}
