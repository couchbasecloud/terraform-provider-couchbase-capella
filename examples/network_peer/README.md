# Capella Network Peers Example

This example shows how to create and manage Network Peers in Capella.

This creates a new network peer in the selected Capella cluster and lists existing network peers in the cluster. It uses the cluster id to create and list network peers.
