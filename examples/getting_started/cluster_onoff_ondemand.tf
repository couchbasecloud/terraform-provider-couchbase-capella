# Stores the cluster onoff details in an output variable.
# Can be viewed using `terraform output cluster_onoff_ondemand` command
output "cluster_onoff_ondemand" {
