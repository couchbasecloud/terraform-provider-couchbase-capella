...
**Previous behavior:** num_replica may have required explicit specification or had a hardcoded default as `zero`
**Current New behavior (post-1.7.0):** num_replica is now computed and known after apply operation, and defined by server
