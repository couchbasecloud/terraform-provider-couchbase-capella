...
## [v1.5.0](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/tree/v1.5.0) (2025-05-20)

[Full Changelog](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/compare/v1.4.1...v1.5.0)

**Implemented enhancements:**

- AV-101826 - Automate adding PR labels [\#334](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/334) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-98659 : Free tier on off implementation [\#286](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/286) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-98401: Adding free tier app service resource [\#283](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/283) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-98308:  Adding free tier bucket resource [\#282](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/282) ([SaicharanCB](https://github.com/SaicharanCB))
- AV 84484 terraform free tier implementation [\#264](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/264) ([SaicharanCB](https://github.com/SaicharanCB))
...
- AV-97306 | Set indexName [\#275](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/275) ([l0n3star](https://github.com/l0n3star))
- AV-97171 - Fix  github files to use ubuntu-latest and sdk upgrade [\#273](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/273) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-97053 | Correctly get default primary index name [\#269](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/269) ([l0n3star](https://github.com/l0n3star))
...
- AV-102211 - Addressing final docs comments [\#339](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/339) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-101713 - Addressing Resources docs review comments [\#338](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/338) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-102119 - Scopes and Collections docs [\#337](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/337) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-101712 - Addressing Datasources docs review comments [\#336](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/336) ([PaulomeeCb](https://github.com/PaulomeeCb))
...
- AV-101710 - Documentation update all resources [\#331](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/331) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-101592 Update index.md and upgrade guide [\#330](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/330) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-101448 - Documentation update all datasources [\#328](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/328) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100853 - Updating Readme [\#327](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/327) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100854 - GSI docs [\#326](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/326) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100850: Adding free-tier cluster docs [\#325](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/325) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100851: Adding free tier on/off docs [\#324](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/324) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100883: Adding cluster on/off schedule docs [\#323](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/323) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100881: Cluster on/off on demand docs [\#322](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/322) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100880: Adding app service on/off docs [\#321](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/321) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100879 : Adding certificate docs [\#320](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/320) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100878: Adding backup schedule docs [\#319](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/319) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100877: Adding backup docs [\#318](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/318) ([SaicharanCB](https://github.com/SaicharanCB))
- \[AV-100866\] feat: Added docs for sample bucket. [\#317](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/317) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100867\] feat: Added docs for project events. [\#316](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/316) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100868\] feat: Added docs for project event. [\#315](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/315) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100869\] feat: Added docs for project. [\#314](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/314) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100870\] feat: Added docs for flush bucket. [\#313](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/313) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100871\] feat: Added docs for events. [\#312](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/312) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100872\] feat: Added docs for event. [\#311](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/311) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100873\] feat: Added docs for database credential. [\#310](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/310) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100874\] feat: Added docs for app service. [\#309](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/309) ([karanjain-ops](https://github.com/karanjain-ops))
- \[AV-100875\] feat: Added docs for apikey. [\#308](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/308) ([karanjain-ops](https://github.com/karanjain-ops))
- AV-100855 - Network peer docs [\#307](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/307) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100856 - Azure network peer command docs [\#306](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/306) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100857- Organization docs [\#305](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/305) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100858 - Private endpoint command docs [\#304](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/304) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100859 - Private endpoint service docs [\#303](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/303) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100860 -  Private endpoints docs [\#302](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/302) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100861 - Audit log export docs [\#301](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/301) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100862 - Audit log settings [\#300](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/300) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100863 - Audit log event ids docs [\#299](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/299) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100864 - Cluster docs [\#298](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/298) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-101023 - Adding import to the docs [\#297](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/297) ([PaulomeeCb](https://github.com/PaulomeeCb))
- AV-100893 - Adding markdown desc to fields - generics approach [\#295](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/295) ([PaulomeeCb](https://github.com/PaulomeeCb))
- \[AV-100865\] feat: Added docs for user. [\#293](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/293) ([karanjain-ops](https://github.com/karanjain-ops))
- AV-100849 : Bucket and free tier bucket docs [\#292](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/292) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100830 Update free tier app services docs [\#291](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/291) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100782 - Allowlist docs generate [\#290](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/290) ([PaulomeeCb](https://github.com/PaulomeeCb))
...
- AV-97194 | update doc [\#274](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/274) ([l0n3star](https://github.com/l0n3star))
- \[AV-97063\] Tie down the versions for golangci-lint and ubuntu [\#270](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/270) ([Talina06](https://github.com/Talina06))
...
- docs: Updated the provider doc to use the correct environment variable [\#263](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/263) ([cdsre](https://github.com/cdsre))
...
- AV-92992 | refactor acceptance tests [\#255](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/255) ([l0n3star](https://github.com/l0n3star))
...
## [v1.5.0](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/tree/v1.5.0) (2025-05-12)
...
- \[AV-100865\] feat: Added docs for user. [\#293](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/293) ([karanjain-ops](https://github.com/karanjain-ops))
- AV-100849 : Bucket and free tier bucket docs [\#292](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/292) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100830 update free tier app services doc [\#291](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/291) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-100782 - Allowlist docs generate [\#290](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/290) ([PaulomeeCb](https://github.com/PaulomeeCb))
- Bump golang.org/x/net from 0.37.0 to 0.38.0 [\#288](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/288) ([dependabot[bot]](https://github.com/apps/dependabot))
- AV-98659 : free tier on off implementation [\#286](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/286) ([SaicharanCB](https://github.com/SaicharanCB))
- AV-98401: adding free tier app service resource [\#283](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/pull/283) ([SaicharanCB](https://github.com/SaicharanCB))
