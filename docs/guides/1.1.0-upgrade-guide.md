...
* You can now enable storage autoexpansion for Azure clusters while creating them via Terraform by simply adding an `autoexpansion` field to the cluster resource.
