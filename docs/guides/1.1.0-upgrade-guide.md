...
For more information, see the [examples to manage scopes](https://github.com/couchbase-cloud/terraform-provider-couchbase-capella/blob/master/examples/bucket/scopes)
...
For more details, see the example for [managing collections](https://github.com/couchbase-cloud/terraform-provider-couchbase-capella/blob/master/examples/bucket/collections)
...
Also check the examples [here](https://github.com/couchbase-cloud/terraform-provider-couchbase-capella/blob/master/examples/sample_bucket) for more details.
...
Take a look at the examples for [Cluster On/Off Schedule](https://github.com/couchbase-cloud/terraform-provider-couchbase-capella/blob/master/examples/cluster_onoff_schedule) to understand how to manage the schedule in detail.
...
For more information, follow the [examples for managing on demand activation of clusters and app services](https://github.com/couchbase-cloud/terraform-provider-couchbase-capella/blob/master/examples/onoff_ondemand)
