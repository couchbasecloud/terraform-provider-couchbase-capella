...
Version 1.6.0 introduces comprehensive support for Couchbase Capella App Endpoints (formerly Sync Gateway), allowing you to configure mobile and edge data synchronization directly through Terraform.

App Endpoints enable you to sync data between Couchbase Server and mobile/edge applications using Couchbase Lite. You can now manage endpoint configuration, authentication, CORS settings, and access control functions as Terraform resources.
...
For more examples, see [app_endpoint examples](https://github.com/couchbasecloud/terraform-provider-couchbase-capella/tree/main/examples/app_endpoint).
